...
(    SELECT 
    ...
    (
        ...
        LEFT JOIN 
        (   
            SELECT CEMPRESA,CBALCAO,CNUMECTA,ZDEPOSIT,ZCLIENTE,SUM(AMOUNT) AS AMOUNT,SUM(SCP1_EMSS_FNCD) AS SCP1_EMSS_FNCD,SUM(SCP2_EMSS_FNCD) AS SCP2_EMSS_FNCD,SUM(SCP3_EMSS_FNCD) AS SCP3_EMSS_FNCD
            FROM BU_CAPTOOLS_WORK.EMI_FINAN_LOCAL 
