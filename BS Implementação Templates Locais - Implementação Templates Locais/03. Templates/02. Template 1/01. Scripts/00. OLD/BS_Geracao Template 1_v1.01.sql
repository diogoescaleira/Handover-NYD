...
(    SELECT 
    ...
    (
        ...
        (
        	SELECT 
        	DISTINCT CEMPRESA,CBALCAO,CNUMECTA,ZDEPOSIT,BRUTO_IMPARIDADE,STAGES,CONTRAPARTE,DATA_VENCIMENTO,PRODUTO,INSTRUMENTO_FINANCEIRO,TIPO_COLATERAL,CPAIS_RESIDENCIA
