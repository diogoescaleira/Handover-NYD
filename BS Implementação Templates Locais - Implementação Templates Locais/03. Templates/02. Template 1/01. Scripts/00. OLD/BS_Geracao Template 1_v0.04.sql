...
(    SELECT 
    ...
    (
        ...
        (   
            ...
            FROM BU_CAPTOOLS_WORK.EMI_FINAN_LOCAL_v2 
            -- WHERE REF_DATE='${REF_DATE}'
            GROUP BY 1,2,3,4,5,6,7,8
        ) EMISS -- alterar para BU_ESG_WORK.MODESG_OUT_EMSS_FNCD
