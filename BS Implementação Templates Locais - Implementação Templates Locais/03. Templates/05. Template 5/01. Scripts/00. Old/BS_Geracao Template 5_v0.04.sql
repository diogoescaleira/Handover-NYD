...
SELECT
	...
	CKCTABEM,
	CKREFBEM,
    SUM(UNI.MSALDO_FINAL*PESO) AS MSALDO_FINAL,
...
(
    ...
    ON  A.CEMPRESA = PESO.CEMPRESA AND
        A.CBALCAO  = PESO.CBALCAO AND
        A.CNUMECTA = PESO.CNUMECTA AND
        A.ZDEPOSIT = PESO.ZDEPOSIT AND
