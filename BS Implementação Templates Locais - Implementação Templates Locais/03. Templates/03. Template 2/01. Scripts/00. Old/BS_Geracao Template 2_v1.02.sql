...
(
    ...
    ) PROPERTY ON CONCAT(PROPERTY.PROPERTY_BANK_ID,PROPERTY.PROPERTY_BRANCH_CODE,PROPERTY.PROPERTY_CONTRACT_ID,PROPERTY.PROPERTY_REFERENCE_CODE) = GAR.CHAVE_BEM
    ...
    (
        ...
        WHERE DATA_DATE_PART = '${REF_DATE}'
    ) CERT_ENERG ON CONCAT(CERT_ENERG.PROPERTY_BANK_ID,CERT_ENERG.PROPERTY_BRANCH_CODE,CERT_ENERG.PROPERTY_CONTRACT_ID,CERT_ENERG.PROPERTY_REFERENCE_CODE) = GAR.CHAVE_BEM
    ...
    SELECT 
        ...
        CONCAT(ADJUD_INPUTS.PROPERTY_BANK_ID,ADJUD_INPUTS.PROPERTY_BRANCH_CODE,ADJUD_INPUTS.PROPERTY_CONTRACT_ID,ADJUD_INPUTS.PROPERTY_REFERENCE_CODE) AS CHAVE_BEM,
        CERT_ENERG.EPC, 
        CASE 
