...
drop table if exists bu_esg_work.ag02_ste_cto_gra;
create table bu_esg_work.ag02_ste_cto_gra as
select 
	a.*,
...
(
	...
	(
		...
		from bu_esg_work.rnm85_restr_dez24 -- a ser mudado para curated_internal_mainframe_reconducoes.rnm85_restr
...
( 
	select distinct b.cempresa,  b.cbalcao, b.cnumecta, b.zdeposit, a.ANNLSD_AGRD_RT as tx_juro_lt from
		...
		where ref_date = '${ref_date}' and ambito = 'PM' and nome_perimetro = 'Individual Local' and segmento = 'ESTR'
		) a 
	left join
...
-- Tabela Final
drop table bu_esg_work.ag02_ste_cto_agr;
create table bu_esg_work.ag02_ste_cto_agr as
select
        tipo_colateral,
        epc_label,
        ep_score,
