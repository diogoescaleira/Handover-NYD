...
SET VAR:REFDATE	= '2023-12-31';
SET VAR:PERIMETRO = 'Individual Local';
SET VAR:DATADATEPART = '2023-12-31';
SET VAR:LEI_CODE_BST = '549300URJH9VSI58CS32';


DROP TABLE IF EXISTS bu_captools_work.codemapping purge;
DROP TABLE IF EXISTS bu_captools_work.vds_out_legalp_instruments purge;
DROP TABLE IF EXISTS bu_captools_work.vds_out_legalp_counterparties purge;
DROP TABLE IF EXISTS bu_captools_work.vds_out_legalp_protections purge;
DROP TABLE IF EXISTS bu_captools_work.vds_out_naturalp_instruments purge;
DROP TABLE IF EXISTS bu_captools_work.vds_out_naturalp_counterparties purge;
DROP TABLE IF EXISTS bu_captools_work.vds_out_naturalp_protections purge;
DROP TABLE IF EXISTS bu_captools_work.vds_out_offbal_instruments purge;
DROP TABLE IF EXISTS bu_captools_work.vds_out_offbal_counterparties purge;
DROP TABLE IF EXISTS bu_captools_work.vds_out_offbal_protections purge;
DROP TABLE IF EXISTS bu_captools_work.vds_out_derivatives purge;
DROP TABLE IF EXISTS bu_captools_work.vds_out_debt_securities  purge;
DROP TABLE IF EXISTS bu_captools_work.vds_out_equity_instruments purge;
DROP TABLE IF EXISTS bu_captools_work.vds_out_dtas purge;
DROP TABLE IF EXISTS bu_captools_work.vds_out_intangible_assets purge;
DROP TABLE IF EXISTS bu_captools_work.vds_out_goodwill purge;
DROP TABLE IF EXISTS bu_captools_work.vds_inp_ct_univ_saldo purge;
DROP TABLE IF EXISTS bu_captools_work.vds_inp_ct_univ_cto purge;
DROP TABLE IF EXISTS bu_captools_work.vds_inp_ct_univ_cli purge;
DROP TABLE IF EXISTS bu_captools_work.vds_inp_ct_univ_titulos purge;
DROP TABLE IF EXISTS bu_captools_work.vds_inp_ct_univ_tat91_206 purge;
DROP TABLE IF EXISTS bu_captools_work.vds_inp_ct_univ_tat91_015 purge;
DROP TABLE IF EXISTS bu_captools_work.vds_inp_ct_univ_finrep purge;
DROP TABLE IF EXISTS bu_captools_work.vds_inp_ct_univ_perimetros purge;
DROP TABLE IF EXISTS bu_captools_work.vds_inp_ct_dim_valor purge;
DROP TABLE IF EXISTS bu_captools_work.vds_inp_ct_univ_cto_v176 purge;
DROP TABLE IF EXISTS bu_captools_work.vds_inp_ct_univ_gr_cli purge;
DROP TABLE IF EXISTS bu_captools_work.vds_inp_al_cnt_core purge;
DROP TABLE IF EXISTS bu_captools_work.vds_inp_al_sld_core  purge;
DROP TABLE IF EXISTS bu_captools_work.vds_inp_kt_chaves_alm purge;
DROP TABLE IF EXISTS bu_captools_work.vds_inp_al_saq_ppc purge;
DROP TABLE IF EXISTS bu_captools_work.vds_inp_al_prog_ppc purge;
DROP TABLE IF EXISTS bu_captools_work.vds_inp_al_peri_alm purge;
DROP TABLE IF EXISTS bu_captools_work.vds_inp_al_det_swapc purge;
DROP TABLE IF EXISTS bu_captools_work.vds_inp_al_derivados purge;
DROP TABLE IF EXISTS bu_captools_work.vds_inp_ept purge;
DROP TABLE IF EXISTS bu_captools_work.vds_inp_fr_pl_contas purge;
DROP TABLE IF EXISTS bu_captools_work.vds_inp_fr_colaterais purge;
DROP TABLE IF EXISTS bu_captools_work.vds_inp_kt_chaves_fr purge;
DROP TABLE IF EXISTS bu_captools_work.vds_inp_fr_recup purge;
DROP TABLE IF EXISTS bu_captools_work.vds_inp_ct_rwa_princ purge;
DROP TABLE IF EXISTS bu_captools_work.vds_inp_ct_rwa_irb purge;
DROP TABLE IF EXISTS bu_captools_work.vds_inp_ct_rwa_cli purge;
DROP TABLE IF EXISTS bu_captools_work.vds_inp_kt_chaves_bdr purge;
DROP TABLE IF EXISTS bu_captools_work.vds_inp_ct_ifrs_expected_loss purge;
DROP TABLE IF EXISTS bu_captools_work.vds_inp_ct_ifrs_out_staging purge;
DROP TABLE IF EXISTS bu_captools_work.vds_inp_kt_chaves_ifrs purge;
DROP TABLE IF EXISTS bu_captools_work.vds_inp_lt_instrument purge;
DROP TABLE IF EXISTS bu_captools_work.vds_inp_lt_entity purge;
DROP TABLE IF EXISTS bu_captools_work.vds_inp_lt_protection purge;
DROP TABLE IF EXISTS bu_captools_work.vds_inp_lt_instr_entity purge;
DROP TABLE IF EXISTS bu_captools_work.vds_inp_lt_instr_prot purge;
DROP TABLE IF EXISTS bu_captools_work.vds_inp_cli_clt18 purge;
DROP TABLE IF EXISTS bu_captools_work.vds_tmp_univ_master purge;
DROP TABLE IF EXISTS bu_captools_work.vds_tmp_alm_master purge;
DROP TABLE IF EXISTS bu_captools_work.vds_tmp_rwa_master purge;
DROP TABLE IF EXISTS bu_captools_work.vds_tmp_ifrs_master purge;
DROP TABLE IF EXISTS bu_captools_work.vds_tmp_loantapes_instr_master purge;
DROP TABLE IF EXISTS bu_captools_work.vds_tmp_loantapes_prtect_master purge;
DROP TABLE IF EXISTS bu_captools_work.vds_tmp_kt_chaves_alm_vs_fr purge;
DROP TABLE IF EXISTS bu_captools_work.vds_tmp_kt_chaves_alm_vs_rwa purge;
DROP TABLE IF EXISTS bu_captools_work.vds_tmp_kt_chaves_alm_vs_ifrs purge;
DROP TABLE IF EXISTS bu_captools_work.vds_tmp_univ_master_t purge;
DROP TABLE IF EXISTS bu_captools_work.vds_tmp_univ_sld_master_t purge;
DROP TABLE IF EXISTS bu_captools_work.vds_tmp_rwa_master_t_p1 purge;
DROP TABLE IF EXISTS bu_captools_work.vds_tmp_rwa_master_t_p2 purge;
DROP TABLE IF EXISTS bu_captools_work.vds_tmp_ifrs_master_t_p1 purge;
DROP TABLE IF EXISTS bu_captools_work.vds_tmp_ifrs_master_t_p2 purge;
DROP TABLE IF EXISTS bu_captools_work.vds_tmp_fr_master_t purge;
DROP TABLE IF EXISTS bu_captools_work.vds_inp_kt_chaves_lt purge;
DROP TABLE IF EXISTS bu_captools_work.vds_tmp_kt_chaves_alm_vs_lt purge;
DROP TABLE IF EXISTS bu_captools_work.vds_tmp_lt_instr_master_t purge;
DROP TABLE IF EXISTS bu_captools_work.vds_tmp_lt_prtect_master_t purge;
DROP TABLE IF EXISTS bu_captools_work.vds_inp_fr_recup_t purge;
DROP TABLE IF EXISTS bu_captools_work.vds_tmp_instrument_master purge;
DROP TABLE IF EXISTS bu_captools_work.vds_tmp_counterparties_master purge;
DROP TABLE IF EXISTS bu_captools_work.vds_tmp_protections_master purge;
DROP TABLE IF EXISTS bu_captools_work.vds_tmp_legalp_instruments purge;
DROP TABLE IF EXISTS bu_captools_work.vds_tmp_legalp_counterparties purge;
DROP TABLE IF EXISTS bu_captools_work.vds_tmp_legalp_protections purge;
DROP TABLE IF EXISTS bu_captools_work.vds_tmp_naturalp_instruments purge;
DROP TABLE IF EXISTS bu_captools_work.vds_tmp_naturalp_counterparties purge;
DROP TABLE IF EXISTS bu_captools_work.vds_tmp_naturalp_protections purge;
DROP TABLE IF EXISTS bu_captools_work.vds_tmp_offbal_instruments purge;
DROP TABLE IF EXISTS bu_captools_work.vds_tmp_offbal_counterparties purge;
DROP TABLE IF EXISTS bu_captools_work.vds_tmp_offbal_protections purge;
DROP TABLE IF EXISTS bu_captools_work.vds_tmp_derivatives purge;
DROP TABLE IF EXISTS bu_captools_work.vds_tmp_debt_securities purge;
DROP TABLE IF EXISTS bu_captools_work.vds_tmp_equity_instruments purge;
...
(
    ...
    FROM cd_estruturais.interface_moradas
    WHERE data_date_part <= ${VAR:REFDATE}
) AS b
...
SELECT	alcntcore.instrument_id_al,
        alcntcore.instrument_id_al_x,
        alcntcore.zcliente,
        alcntcore.dfim_care,
        alcntcore.dinicio,
        alcntcore.dfim,
        alcntcore.cmoeda_pas,
        alcntcore.cmoeda_act,
        alcntcore.dt_prox_renov_taxa_pas,
        alcntcore.dt_prox_renov_taxa_act,
        alcntcore.cod_tipo_taxa_ref_pas,
        alcntcore.cod_tipo_taxa_ref_act,
        alcntcore.tx_spread_pas_1,
        alcntcore.tx_spread_act_1,
        alcntcore.cmetamis,
        alcntcore.cod_freq_amort_capital_act,
        alcntcore.cod_freq_amort_capital_pas,
        alcntcore.cod_tipo_amortizacao,
        alcntcore.cod_freq_liq_jur_pas,
        alcntcore.cod_freq_liq_jur_act,
        alcntcore.cod_freq_taxa_pas,
        alcntcore.cod_freq_taxa_act,
        alcntcore.tx_contrato_pas,
        alcntcore.tx_contrato_act,
        alcntcore.cproduto_mis,
        ...
        clientes.clyr7003_nmorada,
        clientes.clyr7003_nlocalid,
        clientes.clyr7003_cpostal,
        CASE
...
GROUP BY rwamastert.instrument_id_al,
         rwamastert.cod_spv,
         rwamastert.segmento_corep_final,
         rwamastert.ead_final_liquida,
         tabela_sum.ead_final_liquida_sum,
         k2,
         tabela_sum.rwa_final_sum,
         lgdfinal,
         rwamastert.num_empl,
         rwamastert.impfactm_cli,
         rwamastert.idpunsco,
...
--Penso ser completamente desnecessário este count
LEFT JOIN
(
  SELECT contract_id,
         COUNT(*) AS ead_count
...
GROUP BY mastertp1.instrument_id_al,
         mastertp1.ead,
         lgd_ifrs9,
         pd12m_ifrs9,
         pd_lt_ifrs9,
         tabel_sum.ead_sum,
         tabel_sum.final_stage_max;
...
--Tabela de chaves CAPTOOLS vs Loan Tapes
...
--Tabela de chaves ALM vs Loan Tapes

CREATE TABLE bu_captools_work.vds_tmp_kt_chaves_alm_vs_lt AS
SELECT DISTINCT ktchavesalm.instrument_id_al,
...
SELECT  almmaster.zcliente,
        ...
        almmaster.clyr7003_nmorada,
        almmaster.clyr7003_nlocalid,
        almmaster.clyr7003_cpostal,
        univmaster.ctipo_doc_identif1,
        univmaster.cnum_doc_identif1,
        univmaster.clei,
        univmaster.cpais_residencia,
...
SELECT  vtcountermaster.zcliente AS v_2_counterparty_id,
        ...
        vtcountermaster.max_clyr7003_nmorada AS v_201_addr_street,
        vtcountermaster.max_clyr7003_nlocalid AS v_202_addr_city,
        vtcountermaster.max_clyr7003_cpostal AS v_203_addr_postal_code,
...
(
  SELECT  zcliente,
          ...
          MAX(clyr7003_nmorada) AS max_clyr7003_nmorada,
          MAX(clyr7003_nlocalid) AS max_clyr7003_nlocalid,
          MAX(clyr7003_cpostal) AS max_clyr7003_cpostal,
