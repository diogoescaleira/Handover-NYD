...
DROP TABLE IF EXISTS bu_captools_work.query_for_append_table_0001 purge;        --T03.01
DROP TABLE IF EXISTS bu_captools_work.query_for_filter_for_query__0037 purge;   --T03.02
DROP TABLE IF EXISTS bu_captools_work.query_for_ldrmaster_0005_00_0007 purge;   --T03.03
DROP TABLE IF EXISTS bu_captools_work.query_for_filter_for_query__0027 purge;   --T04.00
DROP TABLE IF EXISTS bu_captools_work.query_for_filter_for_query__0026 purge;   --T05.01
DROP TABLE IF EXISTS bu_captools_work.query_for_filter_for_query_0046 purge;    --T06.01
DROP TABLE IF EXISTS bu_captools_work.query_for_al015_act_fin_0001 purge;       --T07.00
DROP TABLE IF EXISTS bu_captools_work.query_for_filter_for_query_003c purge;    --T08.00
DROP TABLE IF EXISTS bu_captools_work.query_for_filter_for_balenc_0000 purge;   --T09.00
DROP TABLE IF EXISTS bu_captools_work.query_for_ldrmaster_0005_00_0005 purge;   --T12.00
...
CREATE TABLE bu_captools_work.query_for_ldrmaster AS
  SELECT ct001.cempresa,
         ...
         ct003.contraparte AS contraparte_i_desc,
         ct063.flag_pme,
         ct003.ccae,
         ct003.gcliente,
         ct003.clei,
  ...
  FROM
  (
    SELECT cempresa, cbalcao, cnumecta, zdeposit, zcliente, descritivo, cmoeda, msaldo_final, ccontab_final_pcsb, ccontab_final_ifrs, flag_ativo, ref_date
  ...
  (
    SELECT cbalcao, cempresa, cnumecta, zdeposit, zcliente, nome_perimetro
  ...
  -- Comentado pois passou-se a atacar a ct003_univ_cli e fr802_pl_contas em vez da ct081_finrep
  -- LEFT JOIN
  --
  -- (
  ...
  --   AND contraparte_i <> ''
  -- ) AS ct081
  -- ON  ct001.cempresa = ct081.cempresa
  -- AND ct001.cbalcao = ct081.cbalcao
  -- AND ct001.cnumecta = ct081.cnumecta
  -- AND ct001.zdeposit = ct081.zdeposit
  --
  -- LEFT JOIN
  --
  -- (
  ...
  ON ct001.zcliente = ct003.zcliente
  ...
  ON  ct001.cempresa = ct004.cempresa
  AND ct001.cbalcao = ct004.cbalcao
  AND ct001.cnumecta = ct004.cnumecta
  AND ct001.zdeposit = ct004.zdeposit
  AND ct001.zcliente = ct004.zcliente
  ...
  ON ct001.zcliente = ct063.zcliente
  ...
  ON  ct001.zcliente = clientes_intragrupo.zcliente
  ...
  ON  ct001.cempresa = al001_pas.cempresa
  AND ct001.cbalcao = al001_pas.cbalcao
  AND ct001.cnumecta = al001_pas.cnumecta
  AND ct001.zdeposit = al001_pas.zdeposit
  AND ct001.zcliente = al001_pas.zcliente
  ...
  ON  ct001.cempresa = al001_act.cempresa
  AND ct001.cbalcao = al001_act.cbalcao
  AND ct001.cnumecta = al001_act.cnumecta
  AND ct001.zdeposit = al001_act.zdeposit
  AND ct001.zcliente = al001_act.zcliente
  ...
  GROUP BY ct001.cempresa,
           ...
           ct00_7_8.nome_contavirt,
           ct010_conta.nome_atributo_dim,
           ct010_dim3.nome_atributo_dim,
           ct010_dim4.nome_atributo_dim,
           ct010_dim5.nome_atributo_dim,
           ct063.flag_pme,
           ct003.ccae,
           ct003.gcliente,
           ct003.clei,
...
CREATE TABLE bu_captools_work.query_for_append_table_0001 AS
  ...
  (
    ...
    (
      ...
      FROM bu_captools_work.query_for_ldrmaster
...
CREATE TABLE bu_captools_work.query_for_filter_for_balenc_0000 AS
  ...
  (
    ...
    GROUP BY ccontab_final_ifrs, correcao_linhas, insolvency_ranking_0001, type_of_non_financial_liabi_0001
  ) balencete_man
