...
WHERE UPPER(t2.nome_atributo_dim) LIKE '%CAPITAL/ NOCIONAL/ CUSTO%'
  OR UPPER(t2.nome_atributo_dim) LIKE 'VALIAS E CORRE%ES DE VALOR POR OPERA%ES MICROCOBERTURA'
GROUP BY t2.cmoeda,
         t2.descritivo,
         t2.nome_atributo_dim5,
         t2.zdeposit,
...
WHERE UPPER(t1.nome_atributo_dim5) LIKE '%CAPITAL/ NOCIONAL/ CUSTO%'
GROUP BY t1.zcliente,
         t1.cmoeda,
         t1.clei,
         t1.contraparte_i_desc,
