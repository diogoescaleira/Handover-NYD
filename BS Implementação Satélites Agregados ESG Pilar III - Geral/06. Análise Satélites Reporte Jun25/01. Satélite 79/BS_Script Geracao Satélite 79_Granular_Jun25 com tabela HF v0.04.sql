-- DROP TABLE BU_CAPTOOLS_WORK.JUN25_SAT79_GRA_PN;

-- CREATE TABLE BU_CAPTOOLS_WORK.JUN25_SAT79_GRA_PN AS
    ...
    (
        ...
        FROM
            ...
            SELECT
                ...
                SOCIEDADE_CONTRAPARTE,
                SUM(SALDO_CT) AS SALDO_CT
            FROM bu_esg_work.RF_PILAR3_UNIVERSO_FULL_Jun25
            WHERE CSATELITE IN (79)
