...
SELECT
	...
	CASE
		WHEN NOME_SPECIFIC_SUSTAINABLE IN ('No','Nao Aplicavel') AND SFICS.NOME_CTGR_SFICS IN ('A.7.7.','A.7.12.','A.7.18.') THEN 'FUTY1'
		WHEN NOME_SPECIFIC_SUSTAINABLE IN ('No','Nao Aplicavel') AND SFICS.NOME_CTGR_SFICS ='Sustainability Linked Finance - Default' THEN 'FUTY2'
		WHEN NOME_SPECIFIC_SUSTAINABLE IN ('No','Nao Aplicavel') AND SFICS.NOME_CTGR_SFICS IN ('A.6.19.') THEN 'FUTY4'
		WHEN NOME_SPECIFIC_SUSTAINABLE IN ('No','Nao Aplicavel') AND SFICS.NOME_CTGR_SFICS IN ('A.1.1.','A.1.3.','A.1.5.','A.1.6.','A.1.9.') THEN 'FUTY5'
		WHEN NOME_SPECIFIC_SUSTAINABLE IN ('No','Nao Aplicavel') AND SFICS.NOME_CTGR_SFICS IN ('A.2.1.','A.2.2.','A.2.3.','A.2.5.','A.2.7.','A.2.14.','A.3.1.','A.3.2.','A.3.7.','A.5.2.','A.8.10.','A.8.23.','KPI Linked - Green','Pure Green counterparty - Default','Student loans') THEN 'FUTY6'	
		ELSE ''
	END AS FUNDING_TYPE,	
