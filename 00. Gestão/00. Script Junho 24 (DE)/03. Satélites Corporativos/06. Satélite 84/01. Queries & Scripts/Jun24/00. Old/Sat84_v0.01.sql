...
-- Dez23        ==>  1 791 426  registos 
--              ==> -48 812 743 855  

drop table bu_esg_work.pilar3_sat84_dez23_tabaux1;
create table bu_esg_work.pilar3_sat84_dez23_tabaux1 as
select  
...
(select
    ...
    from bu_esg_work.rf_pilar3_universo_full                       -- ALTERADA TABELA PARA NOVA TABELA DE IDCOMBS DEZ23
        where DT_RFRNC = '${ref_date}' and csatelite = 84 and idcomb_satelite not like '%MC10%'       
            group by
                sociedade_contraparte, 
                idcomb_satelite,
                cempresa_ct, 
...
-- Dez23        ==>  1 791 426  registos 
--              ==> -48 812 743 855
drop table if exists bu_esg_work.pilar3_sat84_dez23_tabaux2;
create table bu_esg_work.pilar3_sat84_dez23_tabaux2 as
select  distinct
        a.sociedade_contraparte, 
        a.idcomb_satelite,
        a.cempresa_ct, 
...
from (select * from bu_esg_work.pilar3_sat84_dez23_tabaux1) a
left join   
            (select  
                        cempresa_ct,
                        cbalcao_ct,
...
left join (select * from cd_emprestimos.ept01_contas where data_date_part='${ref_date_ept}') ept01 -- '2023-12-29'
...
drop table if exists bu_esg_work.pilar3_sat84_dez23_tabaux3;
create table bu_esg_work.pilar3_sat84_dez23_tabaux3 as
select A.*, 
...
from bu_esg_work.pilar3_sat84_dez23_tabaux2 a
LEFT JOIN
(
...
drop table if exists bu_esg_work.pilar3_sat84_dez23_tabaux4;
create table bu_esg_work.pilar3_sat84_dez23_tabaux4 as
select a.*, 
        case
            	...
            	-- PURE 
                 when  
                      (
                        ...
                        (a.clase_energetica like 'A%' or a.clase_energetica like 'B%') and -- ALTERAÇÃO GUIDELINES 21/12
...
FROM bu_esg_work.pilar3_sat84_dez23_tabaux3 as a 
LEFT JOIN
...
-- 7 859   registos Dez23

DROP TABLE bu_esg_work.Eligibity_racios_dez23;
CREATE TABLE bu_esg_work.Eligibity_racios_dez23 AS
SELECT *
FROM
(
	SELECT  CASE     
...
drop table if exists bu_esg_work.pilar3_sat84_dez23_tabaux5;
create table bu_esg_work.pilar3_sat84_dez23_tabaux5 as 
SELECT   
        a.sociedade_contraparte,
        a.idcomb_satelite,
        a.cempresa_ct,
...
FROM bu_esg_work.pilar3_sat84_dez23_tabaux4 a
LEFT JOIN bu_esg_work.Eligibity_racios_dez23 B
...
-- Dez23       ==>  1 791 426  registos 
--              ==> -48 812 743 855
drop table if exists bu_esg_work.pilar3_sat84_dez23_tabaux6;
create table bu_esg_work.pilar3_sat84_dez23_tabaux6 as     
select a.*,
...
from bu_esg_work.pilar3_sat84_dez23_tabaux5 a
;
...
--              ==> -48 812 743 855
drop table bu_esg_work.pilar3_sat84_dez23_tabaux7;
create table bu_esg_work.pilar3_sat84_dez23_tabaux7 as
select 
...
from bu_esg_work.pilar3_sat84_dez23_tabaux6
group by 1,2,3,4,6,7,8,13,14,15,20,21,22
;
...
-- Dez23       ==>  3 848  registos 
--              ==> -48 812 743 855
drop table bu_esg_work.pilar3_sat84_dez23_tabaux8; 
create table bu_esg_work.pilar3_sat84_dez23_tabaux8 as
...
from bu_esg_work.pilar3_sat84_dez23_tabaux7
...
-- Dez23       ==>  521  registos 
--              ==> 46 504 922,765
drop table bu_esg_work.pilar3_sat84_dez23_adj_tabaux1;
create table bu_esg_work.pilar3_sat84_dez23_adj_tabaux1 as
select distinct
        a.idcomb_satelite, 
        a.sociedade_contraparte,
        a.cod_ajust,
...
from (  
        ...
        where DT_RFRNC = '${ref_date}' and csatelite = 84 and idcomb_satelite  like '%MC10%'                 
        group by 1,2,3,4,5
      ) as a
...
-- Dez23       ==>  521  registos 
--              ==> 46 504 922,765
drop table bu_esg_work.pilar3_sat84_dez23_adj_tabaux2;
create table bu_esg_work.pilar3_sat84_dez23_adj_tabaux2 as 
select
        idcomb_satelite,
        sociedade_contraparte,
        cod_ajust,
...
from bu_esg_work.pilar3_sat84_dez23_adj_tabaux1
;
...
-- Dez23       ==>  521  registos 
--              ==> 46 504 922,765
drop table bu_esg_work.pilar3_sat84_dez23_adj_tabaux3;
create table bu_esg_work.pilar3_sat84_dez23_adj_tabaux3 as
select distinct  
		idcomb_satelite,
        sociedade_contraparte,
        cod_ajust,
...
from bu_esg_work.pilar3_sat84_dez23_adj_tabaux2
;			
...
-- Dez23       ==>  2  registos 
--              ==> 46 504 922,765
drop table bu_esg_work.pilar3_sat84_dez23_adj_tabaux4;
create table bu_esg_work.pilar3_sat84_dez23_adj_tabaux4 as
Select  reporting_soc,
        counterparty_soc,
        adjustment_code,
        id_comb,
...
from (
	...
	'0' as ECCCA,
	'0' as ENCCCA
from bu_esg_work.pilar3_sat84_dez23_adj_tabaux3
where amount <> 0
...
-- Dez23       ==>  2  registos 
--              ==> 46 504 922,765
drop table bu_esg_work.pilar3_sat84_dez23_adj_tabaux5;
create table bu_esg_work.pilar3_sat84_dez23_adj_tabaux5 as
...
amount, 
	...
	ECCCA,
	ENCCCA FROM (												   																								
select * from bu_esg_work.pilar3_sat84_dez23_adj_tabaux4
union
select reporting_soc,counterparty_soc,adjustment_code,id_comb, round(amount) as amount, 
	...
	ECCCA,
	ENCCCA
FROM bu_esg_work.pilar3_sat84_dez23_adj_tabaux4 ) xx;
...
-- Dez23       ==>  2  registos 
--              ==> 46 504 922,765
drop table bu_esg_work.pilar3_sat84_dez23_adj_tabaux6;
create table bu_esg_work.pilar3_sat84_dez23_adj_tabaux6 as
select reporting_soc,counterparty_soc,adjustment_code,id_comb, sum(amount)as amount, 
	...
	ECCCA,
	ENCCCA
	from bu_esg_work.pilar3_sat84_dez23_adj_tabaux5
	group by 
...
drop table if exists bu_esg_work.pilar3_sat84_dez23_final;
create table bu_esg_work.pilar3_sat84_dez23_final as
select * from bu_esg_work.pilar3_sat84_dez23_tabaux8
union all
select * from bu_esg_work.pilar3_sat84_dez23_adj_tabaux6
...
---------------------------------
-- 2 528 
CREATE TABLE bu_esg_work.tradutor_cliente_dez23 AS
SELECT *
FROM
(
	SELECT  KGL_AUX.GLCS,
	...
	ON LEI_AUX.ZCLIENTE = KGL_AUX.ZCLIENTE
	--WHERE NOT(LEI_AUX.ZCLIENTE IS NOT NULL AND KGL_AUX.ZCLIENTE IS NOT NULL)
) RACIOS_ELEG
