...
-- VALIDAÇÕES A CADA EXERCICIO:
--1) Validar lista de produtos a considerar como Motor Vehicle Loans com CdG;
...
-- Jun23        ==> 309 223 registos 

-- Dez23        ==> -12 330 703 151,67 € (Universo Full s/ MC10)
--              ==> 310 411 registos 
--              ==> 12 330 703 151.672943 € 

--drop table if exists bu_esg_work.pilar3_sat93_tabaux1_jun24_1;
create table bu_esg_work.pilar3_sat93_tabaux1_jun24_1_TESTE as
select 
			...
			case
				...
				when substr(a.`14_nace`,1,1) = 'B' and trim(a.`33_counterparty_type`) in ('outras instituicoes financeiras','instituições de crédito') and idcomb_satelite like '%MC08%' then 'CNAEL2'
				when substr(a.`14_nace`,1,1) = 'C' and trim(a.`33_counterparty_type`) in ('outras instituicoes financeiras','instituições de crédito') and idcomb_satelite like '%MC08%' then 'CNAEL3'
				when substr(a.`14_nace`,1,1) = 'D' and trim(a.`33_counterparty_type`) in ('outras instituicoes financeiras','instituições de crédito') and idcomb_satelite like '%MC08%' then 'CNAEL4'
				when substr(a.`14_nace`,1,1) = 'E' and trim(a.`33_counterparty_type`) in ('outras instituicoes financeiras','instituições de crédito') and idcomb_satelite like '%MC08%' then 'CNAEL5'
				when substr(a.`14_nace`,1,1) = 'A' and trim(a.`33_counterparty_type`) in ('outras instituicoes financeiras','instituições de crédito') and idcomb_satelite like '%MC08%' then 'CNAEL1'		
				when substr(a.`14_nace`,1,1) = 'F' and trim(a.`33_counterparty_type`) in ('outras instituicoes financeiras','instituições de crédito') and idcomb_satelite like '%MC08%' then 'CNAEL6'
				when substr(a.`14_nace`,1,1) = 'G' and trim(a.`33_counterparty_type`) in ('outras instituicoes financeiras','instituições de crédito') and idcomb_satelite like '%MC08%' then 'CNAEL7'
				when substr(a.`14_nace`,1,1) = 'H' and trim(a.`33_counterparty_type`) in ('outras instituicoes financeiras','instituições de crédito') and idcomb_satelite like '%MC08%' then 'CNAEL8'
				when substr(a.`14_nace`,1,1) = 'I' and trim(a.`33_counterparty_type`) in ('outras instituicoes financeiras','instituições de crédito') and idcomb_satelite like '%MC08%' then 'CNAEL9'
				when substr(a.`14_nace`,1,1) = 'J' and trim(a.`33_counterparty_type`) in ('outras instituicoes financeiras','instituições de crédito') and idcomb_satelite like '%MC08%' then 'CNAEL10'
				when substr(a.`14_nace`,1,1) = 'L' and trim(a.`33_counterparty_type`) in ('outras instituicoes financeiras','instituições de crédito') and idcomb_satelite like '%MC08%' then 'CNAEL11'
				when substr(a.`14_nace`,1,1) = 'M' and trim(a.`33_counterparty_type`) in ('outras instituicoes financeiras','instituições de crédito') and idcomb_satelite like '%MC08%' then 'CNAEL12'
				when substr(a.`14_nace`,1,1) = 'N' and trim(a.`33_counterparty_type`) in ('outras instituicoes financeiras','instituições de crédito') and idcomb_satelite like '%MC08%' then 'CNAEL13'
				when substr(a.`14_nace`,1,1) = 'O' and trim(a.`33_counterparty_type`) in ('outras instituicoes financeiras','instituições de crédito') and idcomb_satelite like '%MC08%' then 'CNAEL14'
				when substr(a.`14_nace`,1,1) = 'P' and trim(a.`33_counterparty_type`) in ('outras instituicoes financeiras','instituições de crédito') and idcomb_satelite like '%MC08%' then 'CNAEL15'
				when substr(a.`14_nace`,1,1) = 'Q' and trim(a.`33_counterparty_type`) in ('outras instituicoes financeiras','instituições de crédito') and idcomb_satelite like '%MC08%' then 'CNAEL16'
				when substr(a.`14_nace`,1,1) = 'S' and trim(a.`33_counterparty_type`) in ('outras instituicoes financeiras','instituições de crédito') and idcomb_satelite like '%MC08%' then 'CNAEL18'
				when substr(a.`14_nace`,1,1) = 'R' and trim(a.`33_counterparty_type`) in ('outras instituicoes financeiras','instituições de crédito') and idcomb_satelite like '%MC08%' then 'CNAEL17'				
				when trim(a.`33_counterparty_type`) in ('outras instituicoes financeiras','instituições de crédito') then 'CNAEL18'						
				else ''                                           
			end as CNAEL
...
from (																				
				select
						...
						from bu_esg_work.rf_pilar3_universo_full 
							where DT_RFRNC = '${ref_date}' and csatelite = 93 and ID_CORRIDA = '2'
								group by
									sociedade_contraparte, 
									idcomb_satelite,
									cempresa_ct, 
	...
	inner join (select * from bu_esg_work.p3_ctr_cli_v2_all) a	-- Tabela métricas clientes + contrato	 1 811 869 1 811 907
...
-- Dez23        ==>  310 411  registos
--              ==> 12 330 703 151.672943

--drop table if exists bu_esg_work.pilar3_sat93_tabaux1_jun24;
create table bu_esg_work.pilar3_sat93_tabaux1_jun24_TESTE as
select t2.*, 
		case
            when trim(t2.`33_counterparty_type`) = 'outras empresas nao financeiras' and nace_esg.nace_level4 is not null then nace_esg.ID
            when trim(t2.`33_counterparty_type`) = 'outras empresas nao financeiras' then 'NACE19010303' -- nace default disponibilizado pela corporação
            ...
            when trim(t2.`33_counterparty_type`) in ('', 'resto setores / clientes') and idcomb_satelite like '%SC0303%' then 'NACE19010303' -- nace default disponibilizado pela corporação
            
            when trim(t2.`33_counterparty_type`) in ('outras instituicoes financeiras','instituições de crédito') and idcomb_satelite like '%MC08%' and nace_esg.nace_level4 is not null then nace_esg.ID           
            when trim(t2.`33_counterparty_type`) in ('outras instituicoes financeiras','instituições de crédito') and idcomb_satelite like '%MC08%' then 'NACE19010303' -- nace default disponibilizado pela corporação
            when trim(t2.`33_counterparty_type`) in ('outras instituicoes financeiras','instituições de crédito') and idcomb_satelite like '%MC08%' and nace_esg.nace_level4 is not null then nace_esg.ID	
            when trim(t2.`33_counterparty_type`) in ('outras instituicoes financeiras','instituições de crédito') and idcomb_satelite like '%MC08%' then 'NACE19010303' 
            else ''									
        end as nace_esg	
from bu_esg_work.pilar3_sat93_tabaux1_jun24_1_TESTE as t2
...
-- Jun24 (dados dez) => 312 305 (duplicações) 
--drop table if exists bu_esg_work.pilar3_sat93_tabaux2_jun24_1;


 create table bu_esg_work.pilar3_sat93_tabaux2_jun24_1_TESTE as  
select  distinct 
					a.*,
...
-- Identificação do Calculation Approach 
					-- JB(13/07/2024): Alteração Jun24 com base na atualização de produtos CdG (remoção Y45 e adição do 042 para Atividade de Transporte, desconsiderando Energia. 
					case when ((concat(ct004.cproduto,ct004.csubprod) in ('000045','000051','000053') and cdg.cnumecta_ct is not null)
					     ...
					     when ((setor = 'NFC' and GLCS_code is not null and gar.cnumecta_ct is null and `29_flag_specialised_lending`<>'1') -- CIB
								or
							  (setor = 'NFC' and gar.cnumecta_ct is null and `29_flag_specialised_lending`<>'1')) then 'Business Loans' -- NCIB
...
-- Cálculo de Emissões para Business Corporate Loans, Equity & Bonds  ---> Segunda a corporação será tudo o que seja NFC, não tenha colateral associado e não seja Project Finance 
		...
		-- 2º Método de cálculo -- Emissões por atividade física - 
			--A) Emissões com base em energy consumption: não temos informação interna sobre energy source.
			--B) Emissões com base em production: não temos informação interna de counterparty's production nem informação disponível no input.
...
-- Avaliar nos próximos exercícios

-- Cálculo de Emissões para Motor Vehicle Loans  

			-- A) SCORE 1: Actual vehicle specific emissions: não existe informação interna sobre o consumo real nem a distância real percorrida do veículo;
			-- B) SCORE 2 & 3: Estimated vehicle specific emissions: Estimado quando é possível obter o valor de emissões na sheet "Vehicle Loans - PCAF factor" de marca/modelo para país Portugal -- SEM INFO REPRESENTATIVA A DEZ23 e Jun24
  			-- C) SCORE 4: Estimated vehicle unspecific emissions: Desconhecida marca/modelo é usada uma proxy pelo tipo de veículo, tipo de combustível e country
				...
				--Cálculo de emissões, scope 1 e 2, quando sabemos o tipo de viatura e o tipo de combustível
 					case 
						when (a.amount > 0 and valor_financeiro > 0) and setor = 'NFC' and avg_emiss_veh.data_level_1_information is not null and tipo_combustivel is not null
								...
								and (case when ((concat(ct004.cproduto,ct004.csubprod) in ('000045','000051','000053') and cdg.cnumecta_ct is not null)
										  ...
										  when ((setor = 'NFC' and GLCS_code is not null and gar.cnumecta_ct is null and `29_flag_specialised_lending`<>'1')
											   ...
											   (setor = 'NFC' and gar.cnumecta_ct is null and `29_flag_specialised_lending`<>'1')) then 'Business Loans'
												...
												and `29_flag_specialised_lending`<>'1'
								-- Cálculo de Emissões 		
									-- Validar DR + AR: Considerar valor_financeiro e, supletivamente, valor atual da garantia? 
							then (NVL(cast(avg_emiss_veh.scope_1_emission_factor as double),0) * avg_km.average_km) * ((a.amount/1000000)/valor_financeiro) --Casos em que o carro é electrico as emissões de scope 1 estão a null - AC
								...
								and (case when ((concat(ct004.cproduto,ct004.csubprod) in ('000045','000051','000053') and cdg.cnumecta_ct is not null)
										  ...
										  when ((setor = 'NFC' and GLCS_code is not null and gar.cnumecta_ct is null and `29_flag_specialised_lending`<>'1')
											   ...
											   (setor = 'NFC' and gar.cnumecta_ct is null and `29_flag_specialised_lending`<>'1')) then 'Business Loans'
												...
												and `29_flag_specialised_lending`<>'1'
								-- Cálculo de Emissões 																									
							then NVL(cast(avg_emiss_veh.scope_1_emission_factor as double),0) * avg_km.average_km * ((a.amount/1000000)/valor_financeiro) -- Casos em que o carro é a combustão as emissões de scope 2 estão a null - AC
  			...
  			-- D) SCORE 5: Desconhecida marca/modelo é usada uma proxy apenas para Passenger car e apenas com disinção de elétrico e hibrido
					...
					avg_emiss_veh_score5_proxy.scope_1_emission_factor as amount_veh_score5_proxy_scope2, -- Montante da Emissão do ficheiro da corporação (Não temos o tipo de viatura, mapeamos para Passenger Car)
				...
				-- Cálculo de emissões (Scope 1) quando apenas sabemos o tipo de viatura (Metodologia introduzida em Junho 2024 para DQA 5) - AC
					case
						when (a.amount > 0 and valor_financeiro > 0) and setor = 'NFC' and avg_emiss_veh.data_level_1_information is not null and tipo_combustivel is null
						-- Excluir casos de Project Finance e Business Loans - Identificar apenas calculation approach = Motor vehicle loans 
								and (case when ((concat(ct004.cproduto,ct004.csubprod) in ('000045','000051','000053') and cdg.cnumecta_ct is not null)
													or 
							  					(concat(ct004.cproduto,ct004.csubprod) in ('000042')  and cdg.cnumecta_ct is not null and sfcs_green_activity_comgloval like 'Transport%')) then 'Motor vehicle loans'
										  ...
										  when ((setor = 'NFC' and GLCS_code is not null and gar.cnumecta_ct is null and `29_flag_specialised_lending`<>'1')
											   ...
											   (setor = 'NFC' and gar.cnumecta_ct is null and `29_flag_specialised_lending`<>'1')) then 'Business Loans'
												...
												and `29_flag_specialised_lending`<>'1'
								-- Cálculo de Emissões 
							then cast(avg_emiss_veh_score5_type.scope_1_emission_factor as double) * avg_km_score5_type.average_km * ((a.amount/1000000)/valor_financeiro)

				-- Cálculo de emissões (Scope 1) quando não sabemos o tipo de viatura (Usamos o proxy Passenger Car e Average para consigar mapear a distância e emissões) 
						when (a.amount > 0 and valor_financeiro > 0) and setor = 'NFC' and tipo_viatura = '' and  avg_emiss_veh.data_level_1_information is null --and tipo_combustivel not in ('Hybrid','Electric')
								-- Excluir casos de Project Finance e Business Loans - Identificar apenas calculation approach = Motor vehicle loans 
								and (case when ((concat(ct004.cproduto,ct004.csubprod) in ('000045','000051','000053') and cdg.cnumecta_ct is not null)
													or 
							  					(concat(ct004.cproduto,ct004.csubprod) in ('000042')  and cdg.cnumecta_ct is not null and sfcs_green_activity_comgloval like 'Transport%')) then 'Motor vehicle loans' 
										  ...
										  when ((setor = 'NFC' and GLCS_code is not null and gar.cnumecta_ct is null and `29_flag_specialised_lending`<>'1')
											   ...
											   (setor = 'NFC' and gar.cnumecta_ct is null and `29_flag_specialised_lending`<>'1')) then 'Business Loans'
												...
												and `29_flag_specialised_lending`<>'1'
								-- Cálculo de Emissões 																									
							then cast(avg_emiss_veh_score5_proxy.scope_1_emission_factor as double) * avg_km_score5_proxy.average_km * ((a.amount/1000000)/valor_financeiro)
						else null end as emi_veh_score5_scope1,

				-- Cálculo de emissões (Scope 2) quando apenas sabemos o tipo de viatura (Metodologia introduzida em Junho 2024 para DQA 5) - AC
					case
						when (a.amount > 0 and valor_financeiro > 0) and setor = 'NFC' and avg_emiss_veh.data_level_1_information is not null and tipo_combustivel is null
						-- Excluir casos de Project Finance e Business Loans - Identificar apenas calculation approach = Motor vehicle loans 
								and (case when ((concat(ct004.cproduto,ct004.csubprod) in ('000045','000051','000053') and cdg.cnumecta_ct is not null)
										  ...
										  when ((setor = 'NFC' and GLCS_code is not null and gar.cnumecta_ct is null and `29_flag_specialised_lending`<>'1')
											   ...
											   (setor = 'NFC' and gar.cnumecta_ct is null and `29_flag_specialised_lending`<>'1')) then 'Business Loans'
												...
												and `29_flag_specialised_lending`<>'1'
								-- Cálculo de Emissões 
							then avg_emiss_veh_score5_type.scope_2_emission_factor * avg_km_score5_type.average_km * ((a.amount/1000000)/valor_financeiro)
					
				-- Cálculo de emissões (Scope 2) quando não sabemos o tipo de viatura (Usamos o proxy Passenger Car e Average para consigar mapear a distância e emissões) 
						when (a.amount > 0 and valor_financeiro > 0) and setor = 'NFC' and tipo_viatura = '' and  avg_emiss_veh.data_level_1_information is null --and tipo_combustivel not in ('Hybrid','Electric')
								-- Excluir casos de Project Finance e Business Loans - Identificar apenas calculation approach = Motor vehicle loans 
								and (case when ((concat(ct004.cproduto,ct004.csubprod) in ('000045','000051','000053') and cdg.cnumecta_ct is not null)
													or 
										  ...
										  when ((setor = 'NFC' and GLCS_code is not null and gar.cnumecta_ct is null and `29_flag_specialised_lending`<>'1')
											   ...
											   (setor = 'NFC' and gar.cnumecta_ct is null and `29_flag_specialised_lending`<>'1')) then 'Business Loans'
												...
												and `29_flag_specialised_lending`<>'1'
								-- Cálculo de Emissões 																									
							then avg_emiss_veh_score5_proxy.scope_2_emission_factor * avg_km_score5_proxy.average_km * ((a.amount/1000000)/valor_financeiro)		 				
				...
				-- 	CASE WHEN (avg_emiss_veh.data_level_1_information is not null AND tipo_combustivel is not null) THEN '4' end AS dqs4_motor_vehicle_loans, 
...
-- JB(13/07/2024): Alteração de UK de Advanced Economy para EU member
from (select *, 
        ...
        from bu_esg_work.pilar3_sat93_tabaux1_jun24
      ) a		  
...
from bu_esg_work.pilar3_avg_emission_rev_asset_jun24 where functional_unit = 'Revenue') c   
...
from bu_esg_work.pilar3_avg_emission_rev_asset_jun24 where functional_unit = 'Assets') d   
...
( 
	...
	--LEI --1
		...
		from
			(
			select 'Y' as CIB, * from bu_esg_work.pilar3_avg_emission_cib_jun24
			) corp
		inner join 
...
left join 
	(select distinct 
					...
					des_combustivel,
					co2,
					1 as valor_financeiro, --- !!! ALTERAR PARA CAMPO QUANDO TABELA CdG ESTIVER DISPONIVEL
            ...
            from bu_esg_work.rf_pilar3_cdg_tabaux1_dez23_v2	
...
left join            
         (   select distinct 
			    ...
			    from  
        			(   select * 
        			    from bu_esg_work.pilar3_avg_emission_rev_asset_jun24 a 
        			    left join  
        			        (   select *,
										case when tayd91c0_celemtab in ('020', -- Andorra
																	  '036', -- Austrália
																	  '124', -- Canadá
																	  '344', -- Hong Kong
																	  '352', -- Iceland
																	  ...
																	  '158', -- Taiwan 
																	  '840'  -- United States 
																	  ) then 'Advanced economies'
                                                 when tayd91c0_celemtab in ('040', -- Austria
																		  '056', -- Belgium 
																		  '100', -- Bulgaria
																		  '191', -- Croatia
																		  '196', -- Cyprus
...
LEFT JOIN (SELECT * FROM bu_esg_work.motor_vehicle_loans_average_jun24 WHERE country = 'Portugal' AND data_level_5_information = 'Average') avg_km
...
LEFT JOIN (SELECT * FROM	bu_esg_work.motor_vehicle_loans_jun24 WHERE country = 'Portugal' AND data_level_5_information = 'Average') avg_emiss_veh
...
LEFT JOIN (SELECT * FROM bu_esg_work.motor_vehicle_loans_average_jun24 WHERE country = 'Portugal' AND data_level_5_information = 'Average' AND data_level_2_information = 'Average') avg_km_score5_type
...
LEFT JOIN (SELECT * FROM bu_esg_work.motor_vehicle_loans_jun24 WHERE country = 'Portugal' AND data_level_5_information = 'Average' AND data_level_2_information = 'Average') avg_emiss_veh_score5_type
...
LEFT JOIN (SELECT * FROM bu_esg_work.motor_vehicle_loans_jun24 WHERE country = 'Portugal' AND data_level_5_information = 'Average' AND data_level_2_information = 'Average') avg_emiss_veh_score5_proxy
...
LEFT JOIN (SELECT * FROM bu_esg_work.motor_vehicle_loans_average_jun24 WHERE country = 'Portugal' AND data_level_5_information = 'Average' AND data_level_2_information = 'Average') avg_km_score5_proxy
...
-- COMENTÁRIO AR: AUMENTOU MUITO NÚMERO DE REGISTOS
...
select  
		...
		t1.amount_score4_km,
		t1.avg_motor_vehicle_scope1,
		t1.avg_motor_vehicle_scope2,
		t1.elec_avg_motor_vehicle_scope1,
		t1.elec_avg_motor_vehicle_scope2,
		t1.emi_veh_score4_scope1,
		t1.emi_veh_score4_scope2,
		t1.amount_veh_score5_scope1,
		t1.amount_veh_score5_scope2,
		t1.amount_score5_km,
...
(
    select *
    from bu_esg_work.reparticao_garantias_final_dez23
    where ckctabem is null and concat(cempresa_ct,cbalcao_ct,cnumecta_ct,zdeposit_ct) in
    (
...
-- Junção das tabelas que contêm o cálculo de emissões de BCL + 157 (Assets BCL) -- JUN23
-- Jun23        ==> 309 223 registos 

-- Dez23        ==> 310 411  registos 
--              ==> 12 330 703 151.672943 €
--drop table if exists bu_esg_work.pilar3_sat93_tabaux2_jun24_1_aux2;
create table bu_esg_work.pilar3_sat93_tabaux2_jun24_1_aux2_teste as
select t1.* from bu_esg_work.pilar3_sat93_tabaux2_jun24_1_teste t1
/*left join
(
    select *
    from bu_esg_work.reparticao_garantias_final_dez23
...
-- Dez23        ==> 310 411  registos 
--              ==> 12 330 703 151.672943 €
--drop table if exists bu_esg_work.pilar3_sat93_tabaux2_jun24_2_teste;


create table bu_esg_work.pilar3_sat93_tabaux2_jun24_2_teste as  
select *,
...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
from bu_esg_work.pilar3_sat93_tabaux2_jun24_1_aux2_teste;  
...
-- Dez23        ==> 310 411  registos 
--              ==> 12 330 703 151.672943
--drop table if exists bu_esg_work.pilar3_sat93_tabaux2_jun24;
create table bu_esg_work.pilar3_sat93_tabaux2_jun24_teste as 
select *,
...
from bu_esg_work.pilar3_sat93_tabaux2_jun24_2_teste;
...
-- Dez23        ==> 310 411  registos 
--              ==> 12 330 703 151.672943
--drop table if exists bu_esg_work.pilar3_sat93_tabaux_emi_contrato_jun24;

create table bu_esg_work.pilar3_sat93_tabaux_emi_contrato_jun24_teste as 
select  *,
...
from bu_esg_work.pilar3_sat93_tabaux2_jun24_teste;
...
-- Registos a Dezembro2023: 8 951 registos
--						  ==> 6 320 772 700.859307

--drop table if exists bu_esg_work.pilar3_sat93_tabaux3_AUX_jun24_aux_1;

create table bu_esg_work.pilar3_sat93_tabaux3_AUX_jun24_aux_1_teste as
    ...
    -- 2º Método: Estimated building emissions based on floor area
            -- A) Emissions based on official building energy labels and the floor area 
                    -- Ir buscar tudo o que tenha um colateral, seja ele residencial ou comercial (real estate collaterals) + sabemos o tipo de building
																				...
																				-- Data Quality 3
                    -- Scope 1 
							--Escritório (junção do mesmo case when para as duas categorias)
						 
                    case 
						when setor = 'NFC' and t2.ckctabem is not null and (t2.narutil is not null and t2.narutil > 0) 
											and `29_flag_specialised_lending`<> '1' 
							   ...
							   --Habitação agragado ao case when para somar na mesma variavel
						when setor = 'NFC' and t2.ckctabem is not null and (t2.narutil is not null and t2.narutil > 0) 
											and `29_flag_specialised_lending`<> '1' 
											and (trim(clase_energetica) <> '' and clase_energetica is not null and fiabilidad in ('SANTANDER','','1-REAL'))
                                            -- and cnael = 'CNAEL11' -- NACE de Real Estate Activities     
                    ...
                    -- Scope 2    ,cast (scope1_emission_factor as decimal (30,16)) as 
                    case
						when setor = 'NFC' and t2.ckctabem is not null and t2.narutil is not null and t2.narutil > 0 
														and `29_flag_specialised_lending`<>'1' 
                    									and trim(clase_energetica) <>'' and clase_energetica is not null and fiabilidad in ('SANTANDER','','1-REAL')
						...
						when setor = 'NFC' and t2.ckctabem is not null and t2.narutil is not null and t2.narutil > 0 and `29_flag_specialised_lending`<>'1' 
						and `29_flag_specialised_lending`<>'1'  
                    									and trim(clase_energetica) <>'' and clase_energetica is not null and fiabilidad in ('SANTANDER','','1-REAL')
                                                        -- and cnael = 'CNAEL11' -- NACE de Real Estate Activities     
                                                        and trim(pais.cfinbem) = '01' and real_estate_Residential.data_lvl2_info is not null
                    ...
                    -- Scope 1
                    case when setor = 'NFC' and t2.ckctabem is not null and t2.narutil is not null and t2.narutil > 0 and `29_flag_specialised_lending`<>'1'  
                    									and trim(clase_energetica) <>'' and clase_energetica is not null 
														and fiabilidad in ('SANTANDER','','1-REAL')
                                    ...
                                    then (cast(real_estate_others.scope1_emission_factor as decimal (30,22)) *  t2.narutil ) * (cast(AF as decimal(30,6))) end as emi_scope1_nbuilding,
                    -- Scope 2
                    case when setor = 'NFC' and t2.ckctabem is not null and t2.narutil is not null and t2.narutil > 0 and `29_flag_specialised_lending`<>'1'  
                    									and trim(clase_energetica) <>'' and clase_energetica is not null and fiabilidad in ('SANTANDER','','1-REAL')
                                                        and `32_type_collateral`='COMERCIAL'
                                                        ...
                                                        and real_estate_others.asset_class = 'Commercial real estate'
                                                        and real_estate_others.data_lvl2_info ='Non-residential total'      
                                    then (cast(real_estate_others.scope2_emission_factor as decimal (30,22)) *  t2.narutil ) * (cast(AF as decimal(30,6))) end as emi_scope2_nbuilding,
...
-- For countries outside of Europe, the US and Canada, CRE emissions must be calculated as business loans, using the PCAF factor for NACE L – Real Estate Activities    --> Falta implementar esta componente 
                    ...
                    case when setor = 'NFC' and t2.ckctabem is not null and t2.narutil is not null and t2.narutil > 0 and `29_flag_specialised_lending`<>'1'  
                                    ...
                                    then (cast(real_estate_total_floor.scope1_emission_factor as decimal (30,22)) *  t2.narutil ) * (cast(AF as decimal(30,6))) end as emi_scope1_totalfloor,
                    -- Scope 2
                    case when setor = 'NFC' and t2.ckctabem is not null and t2.narutil is not null and t2.narutil > 0 and `29_flag_specialised_lending`<>'1'  
                    									and trim(clase_energetica) <>'' and clase_energetica is not null and fiabilidad in ('SANTANDER','','1-REAL')
                                                        and `32_type_collateral` = 'RESIDENCIAL'
                                                        -- and cnael = 'CNAEL11' -- NACE de Real Estate Activities
                                                        and real_estate_total_floor.asset_class = 'Residential real estate'
                                    then (cast(real_estate_total_floor.scope2_emission_factor as decimal (30,22)) *  t2.narutil ) * (cast(AF as decimal(30,6))) end as emi_scope2_totalfloor,  
            ...
            -- B) Emissions based on building type and location-specific statistical data, and the floor area 
                    ...
                    case 
                        when setor = 'NFC' and t2.ckctabem is not null and t2.narutil is not null and t2.narutil > 0 and `29_flag_specialised_lending`<>'1' 
                                                        ...
                                                        -- and cnael = 'CNAEL11' -- NACE de Real Estate Activities                     
                                                        and trim(pais.cfinbem) = '03' and real_estate_total_emitensity_office.data_lvl2_info is not null
					   ...
					   when setor = 'NFC' and t2.ckctabem is not null and t2.narutil is not null and t2.narutil > 0 and `29_flag_specialised_lending`<>'1' 
                    									and (trim(clase_energetica) ='' or clase_energetica is null)
                                                        -- and cnael = 'CNAEL11' -- NACE de Real Estate Activities                     
                                                        and trim(pais.cfinbem) = '01' and real_estate_total_emitensity_residential.data_lvl2_info is not null
                                -- Restrição caso exista nas restrições acima, então vai levar com o maior nível de data quality score de cima 
                    ...
                    case when setor = 'NFC' and t2.ckctabem is not null and t2.narutil is not null and t2.narutil > 0 and `29_flag_specialised_lending`<>'1'
                                    ...
                                    then (cast(real_estate_total_emitensity_eu_america_com.scope1_emission_factor as decimal (30,22)) *  t2.narutil ) * (cast(AF as decimal(30,6))) end as emi_scope1_nbuilding_eur,
                    -- Scope 2                
                    case when setor = 'NFC' and t2.ckctabem is not null and t2.narutil is not null and t2.narutil > 0 and `29_flag_specialised_lending`<>'1' 
                    									and (trim(clase_energetica) ='' or clase_energetica is null)
                                                        -- and cnael = 'CNAEL11' -- NACE de Real Estate Activities 
                                                        ...
                                                        and real_estate_total_emitensity_eu_america_com.asset_class = 'Commercial real estate'
                                                        and real_estate_total_emitensity_eu_america_com.data_lvl2_info ='Non-residential buildings'
                                    then (cast(real_estate_total_emitensity_eu_america_com.scope2_emission_factor as decimal (30,22)) *  t2.narutil ) * (cast(AF as decimal(30,6))) end as emi_scope2_nbuilding_eur,   
                    ...
                    -- Ir buscar informação de tudo o que tenha colateral + não sabemos o tipo de building + ser comercial + ser América do Norte - Canadá
																			...
																			--Parte que retorna NULL em todos os cruzamentos com o input pois não existe dados para América do Norte e Canadá
                    -- Scope 1
                    case when setor = 'NFC' and t2.ckctabem is not null and t2.narutil is not null and t2.narutil > 0 and `29_flag_specialised_lending`<>'1' 
                    									and (trim(clase_energetica) ='' or clase_energetica is null)
                                                        -- and cnael = 'CNAEL11' -- NACE de Real Estate Activities 
                                    ...
                                    then (cast(real_estate_total_emitensity_eu_america_com.scope1_emission_factor as decimal (30,22)) *  t2.narutil ) * (cast(AF as decimal(30,6))) end as emi_scope1_nbuilding_canada,
                    -- Scope 2               
                    case when setor = 'NFC' and t2.ckctabem is not null and t2.narutil is not null and t2.narutil > 0 and `29_flag_specialised_lending`<>'1' 
                    									and (trim(clase_energetica) ='' or clase_energetica is null)
                                                        -- and cnael = 'CNAEL11' -- NACE de Real Estate Activities 
                                                        ...
                                                        and real_estate_total_emitensity_eu_america_com.asset_class = 'Commercial real estate'
                                                        and real_estate_total_emitensity_eu_america_com.data_lvl2_info ='All buildings'
                                    then (cast(real_estate_total_emitensity_eu_america_com.scope2_emission_factor as decimal (30,22)) *  t2.narutil ) * (cast(AF as decimal(30,6))) end as emi_scope2_nbuilding_canada,
                    ...
                    case when setor = 'NFC' and t2.ckctabem is not null and t2.narutil is not null and t2.narutil > 0 and `29_flag_specialised_lending`<>'1' 
                                    ...
                                    then (cast(real_estate_total_emitensity_eu_america_com.scope1_emission_factor as decimal (30,22)) *  t2.narutil ) * (cast(AF as decimal(30,6))) end as emi_scope1_nbuilding_us,
                    -- Scope 2                
                    case when setor = 'NFC' and t2.ckctabem is not null and t2.narutil is not null and t2.narutil > 0 and `29_flag_specialised_lending`<>'1' 
                    									and (trim(clase_energetica) ='' or clase_energetica is null)
                                                        -- and cnael = 'CNAEL11' -- NACE de Real Estate Activities 
                                                        ...
                                                        and real_estate_total_emitensity_eu_america_com.asset_class = 'Commercial real estate'
                                                        and real_estate_total_emitensity_eu_america_com.data_lvl2_info ='Other'
                                    then (cast(real_estate_total_emitensity_eu_america_com.scope2_emission_factor as decimal (30,22)) *  t2.narutil ) * (cast(AF as decimal(30,6))) end as emi_scope2_nbuilding_us,                                                            
                   ...
                   -- 3º Método: Estimated building emissions based on number of buildings                     
                    ...
                    -- Ir buscar tudo o que tenha um colateral (residencial ou comercial) + sabemos o tipo de building + filtro dwelling + filtro Emission Intensity per m²                  
                    -- Scope 1 real_estate_residential_dwelling_inten
                    case 
					
					--Escritorio
						when setor = 'NFC' and t2.ckctabem is not null and `29_flag_specialised_lending`<>'1' 
                                                        -- and cnael = 'CNAEL11' -- NACE de Real Estate Activities                     
						...
						when setor = 'NFC' and t2.ckctabem is not null and `29_flag_specialised_lending`<>'1' 
                                                        -- and cnael = 'CNAEL11' -- NACE de Real Estate Activities                     
                                                        and trim(pais.cfinbem) = '01' and real_estate_residential_dwelling_inten.data_lvl2_info is not null
                                -- Restrição caso exista nas restrições acima, então vai levar com o maior nível de data quality score de cima 
                    ...
                    case when setor = 'NFC' and t2.ckctabem is not null and `29_flag_specialised_lending`<>'1' 
                                    ...
                                    then (cast(real_estate_total_emitensity_eu_america_3.scope1_emission_factor as decimal (30,10)) * cast(n_bens as double)) * (cast(AF as decimal(30,10))) end as emi_scope1_nbuildings_eur,
                    -- Scope 2               
                    case when setor = 'NFC' and t2.ckctabem is not null and `29_flag_specialised_lending`<>'1' 
                                                        -- and cnael = 'CNAEL11' -- NACE de Real Estate Activities 
                                                        and `32_type_collateral`='COMERCIAL'
                                                        ...
                                                        and real_estate_total_emitensity_eu_america_3.asset_class = 'Commercial real estate'
                                                        and real_estate_total_emitensity_eu_america_3.data_lvl2_info ='Non-residential buildings'
                                    then (cast(real_estate_total_emitensity_eu_america_3.scope2_emission_factor as decimal (30,10)) * cast(n_bens as double)) * (cast(AF as decimal(30,10))) end as emi_scope2_nbuildings_eur,    
                    ...
                    case when setor = 'NFC' and t2.ckctabem is not null and `29_flag_specialised_lending`<>'1' 
                                    ...
                                    then (cast(real_estate_total_emitensity_eu_america_3.scope1_emission_factor as decimal (30,22)) * cast(n_bens as double)) * (cast(AF as decimal(30,22))) end as emi_scope1_nbuildings_canada,
                    -- Scope 2
                    case when setor = 'NFC' and t2.ckctabem is not null and `29_flag_specialised_lending`<>'1' 
                                                        -- and cnael = 'CNAEL11' -- NACE de Real Estate Activities 
                                                        and `32_type_collateral`='COMERCIAL'
                                                        ...
                                                        and real_estate_total_emitensity_eu_america_3.asset_class = 'Commercial real estate'
                                                        and real_estate_total_emitensity_eu_america_3.data_lvl2_info ='All buildings'
                                    then (cast(real_estate_total_emitensity_eu_america_3.scope2_emission_factor as decimal (30,22)) * cast(n_bens as double)) * (cast(AF as decimal(30,22))) end as emi_scope2_nbuildings_canada,
                    ...
                    case when setor = 'NFC' and t2.ckctabem is not null and `29_flag_specialised_lending`<>'1' 
                                    ...
                                    then (cast(real_estate_total_emitensity_eu_america_3.scope1_emission_factor as decimal (30,22)) * cast(n_bens as double)) * (cast(AF as decimal(30,22))) end as emi_scope1_nbuilding_us_met3,
                    -- Scope 2
                    case when setor = 'NFC' and t2.ckctabem is not null and `29_flag_specialised_lending`<>'1' 
                                                        -- and cnael = 'CNAEL11' -- NACE de Real Estate Activities 
                                                        and `32_type_collateral`='COMERCIAL'
                                                        ...
                                                        and real_estate_total_emitensity_eu_america_3.asset_class = 'Commercial real estate'
                                                        and real_estate_total_emitensity_eu_america_3.data_lvl2_info ='Other'
                                    then (cast(real_estate_total_emitensity_eu_america_3.scope2_emission_factor as decimal (30,22)) * cast(n_bens as double)) * (cast(AF as decimal(30,22))) end as emi_scope2_nbuilding_us_met3,                                                          
                    ...
                    case when setor = 'NFC' and t2.ckctabem is not null and `29_flag_specialised_lending`<>'1' 
                                    ...
                                    then (cast(real_estate_total_emitensity_dwell_eu_am_res_3.scope1_emission_factor as decimal (30,22)) * cast(n_bens as double)) * (cast(AF as decimal(30,22))) end as emi_scope1_nbuilding_res_met3,
                    -- Scope 2               
                    case when setor = 'NFC' and t2.ckctabem is not null and `29_flag_specialised_lending`<>'1' 
                                                        and `32_type_collateral` = 'RESIDENCIAL'
                                                        -- and cnael = 'CNAEL11' -- NACE de Real Estate Activities
                                                        and real_estate_total_emitensity_dwell_eu_am_res_3.asset_class = 'Residential real estate'
                                    then (cast(real_estate_total_emitensity_dwell_eu_am_res_3.scope2_emission_factor as decimal (30,22)) * cast(n_bens as double)) * (cast(AF as decimal(30,22))) end as emi_scope2_nbuilding_res_met3,				


-- DATA QUALITY SCORE									
            --Mapeado os valores de data quality de residencial e office para o mesmo valor para não serem alterados os mapeamentos dos seguintes codigos de tabelas auxiliares

                    case 
                        when real_estate_office.pcaf_dqs is not null
                            then real_estate_office.pcaf_dqs 
                        when real_estate_residential.pcaf_dqs is not null 
                            then real_estate_residential.pcaf_dqs 
                        end as  dqs_office,
                    ...
                    --Mapeado os valores de data quality de residencial e office para o mesmo valor para não serem alterados os mapeamentos dos seguintes codigos de tabelas auxiliares
                        case 
                        when real_estate_total_emitensity_office.pcaf_dqs is not null
                            then real_estate_total_emitensity_office.pcaf_dqs 
                        when real_estate_total_emitensity_Residential.pcaf_dqs is not null 
                            then real_estate_total_emitensity_Residential.pcaf_dqs 
...
--Mapeado os valores de data quality de residencial e office para o mesmo valor para não serem alterados os mapeamentos dos seguintes codigos de tabelas auxiliares
                        case 
                        when real_estate_office_dwelling_inten.pcaf_dqs is not null
                            then real_estate_office_dwelling_inten.pcaf_dqs 
                        when real_estate_residential_dwelling_inten.pcaf_dqs is not null 
                            then real_estate_residential_dwelling_inten.pcaf_dqs 
...
left join
            ( 
                select *
                from bu_esg_work.gpt32_bemimove_dez23 --- IMPORTANTE: CORRER ESTA TABELA NO FINAL DO MÊS DO RÁCIO
            ) b 
                on t1.ckbalbem = b.ckbalbem
                and t1.ckctabem = b.ckctabem ) t2
...
-- Cruzamento para aferir o número de buildings/bens        
    left join
        ...
        (
            ...
            from bu_esg_work.reparticao_garantias_final_dez23_v2 as a
...
-- Cruzamento para o que é Commercial Real Estate e não sabemos o tipo de edifício e encontra-se dentro da Europa + Floor Area
        ...
        left join ( 
                    select *,upper(country) as key_country
                    from bu_esg_work.pilar3_avg_emission_realstate_jun24 
...
-- Cruzamento para o que é Residencial Real Estate e não sabemos o tipo de edifício e encontra-se dentro da Europa + Floor Area
        left join ( 
                    ...
                    from bu_esg_work.pilar3_avg_emission_realstate_jun24 
                    where functional_unit_name in ('Floor area','floor area') 
					and trim(state_) = '' 
...
-- Cruzamento para o que sabemos o tipo de edifício e o factor name é Emission Intensity per m² + Floor Area
        left join ( 
                    ...
                    from bu_esg_work.pilar3_avg_emission_realstate_jun24 
                    where functional_unit_name in ('Floor area','floor area')
					and emission_factor_name = 'Emission Intensity per m²' and trim(state_) = ''
                     and country = 'Portugal'
...
-- Cruzamento para o que não sabemos o tipo de edifício e o factor name é Emission Intensity per m², é Commercial Real Estate e está na Europa ou América do Norte + Floor Area 
        left join ( 
                    ...
                    from bu_esg_work.pilar3_avg_emission_realstate_jun24 
                    where (functional_unit_name in ('Floor area','floor area')
					and emission_factor_name = 'Emission Intensity per m²' and trim(state_) = '') and asset_class='Commercial real estate' and
                        ((Region='Europe' and data_lvl2_info ='Non-residential buildings') or (Region='North America' and data_lvl2_info ='All buildings'))
		...
		-- Cruzamento para sabemos o tipo de edifício e o factor name é Emission Intensity per # + Dwelling (Office)
        left join ( 
                    select  * ,upper( country) as key_country
                    from bu_esg_work.pilar3_avg_emission_realstate_jun24 
                    where   data_lvl2_info = 'Non-residential buildings' 	--Foi assumido valor para OFFICE (DEZ23) ->	Non-residential buildings para JUN24	  
					and functional_unit_name = 'Dwelling' --Tipo pode não ser restrigido por DWELLING rever em futuros exercicios
		...
		-- Cruzamento para sabemos o tipo de edifício e o factor name é Emission Intensity per # + Dwelling (Residencial)
        left join ( 
                    select  * ,upper( country) as key_country
                    from bu_esg_work.pilar3_avg_emission_realstate_jun24 
                    where  data_lvl2_info = 'Residential Total'    
...
-- Registos a Dezembro2023: 8 951 registos	
--       				   ==> 6 320 772 700.859307	€ 
--drop table if exists bu_esg_work.pilar3_sat93_tabaux3_AUX_jun24_aux_2;
create table bu_esg_work.pilar3_sat93_tabaux3_AUX_jun24_aux_2_teste as
select *, 
...
from bu_esg_work.pilar3_sat93_tabaux3_AUX_jun24_aux_1_teste;
...
-- Registos a Dezembro2023: 8 951 registos
-- 						 ==> 
--drop table if exists bu_esg_work.pilar3_sat93_tabaux3_AUX_jun24_aux;
--drop table bu_esg_work.pilar3_sat93_tabaux3_AUX_jun24_aux_teste
create table bu_esg_work.pilar3_sat93_tabaux3_AUX_jun24_aux_teste as
select *, 
...
from  bu_esg_work.pilar3_sat93_tabaux3_AUX_jun24_aux_2_teste;
...
-- Registos a Dezembro2023: 8 951 registos
--						  ==> 6 320 772 700.859307 €
--drop table if exists bu_esg_work.pilar3_sat93_tabaux3_AUX_jun24;
--drop table bu_esg_work.pilar3_sat93_tabaux3_AUX_jun24_teste
create table bu_esg_work.pilar3_sat93_tabaux3_AUX_jun24_teste as
select *,
		-- Flag de Calculation Approach
        case when ckctabem is not null then  1 else 0 end as flg_calculation_approach_2
from bu_esg_work.pilar3_sat93_tabaux3_AUX_jun24_aux_teste;
...
-- Registos a Dezembro2023: 8 951 registos
--                       ==> 6 320 772 700.859307€ 					
--drop table bu_esg_work.pilar3_sat93_tabaux_emi_colat_aux_jun24;
--drop table bu_esg_work.pilar3_sat93_tabaux_emi_colat_aux_jun24_teste
create table bu_esg_work.pilar3_sat93_tabaux_emi_colat_aux_jun24_teste as 
select  *,
        -- emissões finais scope 1
        case 
		...
		'' as dqs_scope3_gar
from bu_esg_work.pilar3_sat93_tabaux3_AUX_jun24_teste;

-- 12º Passo e meio: Criação da tabela preliminar de colaterais com o somatorio das emissões por contrato
-- Registos a Dezembro2023: 8 811 registos (devido à desagregação dos vários colaterais por contrato)
-- Registos a Dezembro2023: 8 951 registos
--drop table if exists bu_esg_work.pilar3_sat93_tabaux_emi_colat_jun24;
--drop table bu_esg_work.pilar3_sat93_tabaux_emi_colat_jun24_teste 
create table bu_esg_work.pilar3_sat93_tabaux_emi_colat_jun24_teste as 
...
from bu_esg_work.pilar3_sat93_tabaux_emi_colat_aux_jun24_teste
...
-- Registos a Dezembro2023: 8 811 registos (devido à desagregação dos vários colaterais por contrato)
-- Registos a Dezembro2023: 8 951 registos
--drop table if exists bu_esg_work.pilar3_sat93_tabaux3_jun24;
--drop table bu_esg_work.pilar3_sat93_tabaux3_jun24_teste
create table bu_esg_work.pilar3_sat93_tabaux3_jun24_teste as
select 
        t2.*,
...
from bu_esg_work.pilar3_sat93_tabaux_emi_colat_jun24_teste as t2
	left join bu_esg_work.nace_esg_pillar3 as nace_esg								
			on concat(split_part(t2.`15_nace_esg`,".",1),split_part(t2.`15_nace_esg`,".",2),split_part(t2.`15_nace_esg`,".",3)) = trim(split_part(nace_esg.nace_level4, "-",1));
...
-- Registos a Dezembro2023: 309 registos
-- 						  ==> 923 850 929.900000€ 
                            1 314 415 090.990000
--drop table bu_esg_work.sat93_agregacao_jun24_aux;
--drop table  bu_esg_work.sat93_agregacao_jun24_aux_teste
create table bu_esg_work.sat93_agregacao_jun24_aux_teste as
select 
		reporting_soc,
		sociedade_contraparte,
		case when sociedade_contraparte = '' then '00000' else sociedade_contraparte end as counterparty_soc,
...
-- Registos a Dezembro2023: 309 registos
--drop table bu_esg_work.sat93_agregacao_jun24_aux2;
create table bu_esg_work.sat93_agregacao_jun24_aux2_teste as
select distinct 
        t1.reporting_soc,
        t1.sociedade_contraparte,
        t1.cod_ajust,
        ...
        t1.dqs_revenues,
        t1.dqs_assets  
from bu_esg_work.sat93_agregacao_jun24_aux t1
;

-- Marcação de flag de cálculo para os casos anteriores
-- Registos a Junho2023: 5 853 registos 
-- Registos a Dezembro2023: 309 registos
--drop table if exists bu_esg_work.sat93_agregacao_jun24_aux3;
--create table bu_esg_work.sat93_agregacao_jun24_aux3 as  
select *,
------------------------------------------------------------------------------------------------------------------ Tracking de flags de mapeamento -----------------------------------------------------------------------------------------
	-- Emissões por contraparte - CIB SCOPE 1 
	0 as flg_cib_scope1,					
...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
from bu_esg_work.sat93_agregacao_jun24_aux2;

-- Registos a Junho2023: 5 853 registos 
-- Registos a Dezembro2023: 309 registos
--drop table if exists bu_esg_work.sat93_agregacao_jun24_aux4;
--create table bu_esg_work.sat93_agregacao_jun24_aux4 as 
select *,
       0 as flg_economic_rev_scope3,
       0 as flg_economic_rev_scope2
from bu_esg_work.sat93_agregacao_jun24_aux3;

-- Registos a Junho2023: 5 853 registos 
-- Registos a Dezembro2023: 309 registos
--drop table if exists bu_esg_work.sat93_agregacao_jun24_aux5;
--create table bu_esg_work.sat93_agregacao_jun24_aux5 as 
select  *,
	    -- Emissões finais scope 1
...
from bu_esg_work.sat93_agregacao_jun24_aux4;
...
-- Registos a Dezembro2023: 312 744 registos
--                        ==> 14 511 898 490.562943 € 
--drop table bu_esg_work.sat93_agregacao_jun24;
--create table bu_esg_work.sat93_agregacao_jun24 as
select distinct
		reporting_soc,
		sociedade_contraparte,
		case when sociedade_contraparte = '' then '00000' else sociedade_contraparte end as counterparty_soc,
		...
		from bu_esg_work.pilar3_sat93_tabaux_emi_contrato_jun24
		where calculation_approach_1 <> '' 
union all
select distinct
		reporting_soc,
		...
		NULL as dqs_scope2_gar,
		NULL as dqs_scope3_gar
		from bu_esg_work.sat93_agregacao_jun24_aux5
union all
select distinct
		reporting_soc,
		sociedade_contraparte,
		...
		dqs_scope2_gar,
		dqs_scope3_gar
		from bu_esg_work.pilar3_sat93_tabaux3_jun24
		where calculation_approach_1 = '' and
             concat(cempresa_ct,cbalcao_ct,cnumecta_ct,zdeposit_ct) not in (select concat(cempresa_ct,cbalcao_ct,cnumecta_ct,zdeposit_ct) from bu_esg_work.sat93_agregacao_jun24_aux5);
...
-- Registos a Dezembro2023:  312 744   registos
--                        ==> 14 511 898 490.562943 € 
--drop table if exists bu_esg_work.sat93_agregacao2_jun24_1;
--create table bu_esg_work.sat93_agregacao2_jun24_1 as
select 
        t1.*,			 
...
from bu_esg_work.sat93_agregacao_jun24 as t1;

-- Registos a Dezembro2023: 312 744  registos
--                        ==> 14 511 898 490.562943 € 
--drop table if exists bu_esg_work.sat93_agregacao2_jun24_v2;
--create table bu_esg_work.sat93_agregacao2_jun24_v2 as
select *, 
...
from bu_esg_work.sat93_agregacao2_jun24_1;	



-- Número de registos a Dezembro de 2022: 1 968 registos 
-- Registos a Junho2023: 2 028 registos
-- Registos a Dezembro2023: 2 589 registos
--drop table if exists bu_esg_work.pilar3_sat93_tabaux4_jun24_v2;
--create table bu_esg_work.pilar3_sat93_tabaux4_jun24_v2 as
select 
        a.reporting_soc,
        a.counterparty_soc,
...
from bu_esg_work.sat93_agregacao2_jun24_v2 as a 
group by 		
		a.reporting_soc,
        a.counterparty_soc,
		a.cod_ajust,
...
-- Registos a Junho2023: 2 028 registos
-- Registos a Dezembro2023: 2 589 registos
--drop table bu_esg_work.pilar3_sat93_tabaux5_jun24_v2;
--create table bu_esg_work.pilar3_sat93_tabaux5_jun24_v2 as 
select 
        reporting_soc,
        counterparty_soc,
        adjustment_code,
...
from bu_esg_work.pilar3_sat93_tabaux4_jun24_v2;


insert overwrite table  bu_esg_work.RT_PILAR3_SATELITE93 partition (DT_RFRNC, PROC_ID)
...
from bu_esg_work.pilar3_sat93_tabaux5_jun24_v2

left join
(Select nvl(max(PROC_ID),0)+1 as NEW_PROC_ID from bu_esg_work.RT_PILAR3_SATELITE93) RT
on 1=1
;
