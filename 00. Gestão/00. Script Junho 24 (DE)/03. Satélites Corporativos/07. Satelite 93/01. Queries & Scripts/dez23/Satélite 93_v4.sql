...
left join 
	(select distinct 
					...
					case when ckprodmi in ('000045','000051','000053','000Y45') and des_detalle_lease  = 'VEICULOS PESADOS DE PASSAGEIROS' then 'Bus'
						 when ckprodmi in ('000045','000051','000053','000Y45') and des_detalle_lease in ('COMERCIAIS ATE 1600KG','COMERCIAIS DE 1601KG A 2600KG','COMERCIAIS DE 2601KG A 3500KG', 'VEICULOS LIGEIROS DE MERCADORIAS') then 'Heavy Vehicle'
						 when ckprodmi in ('000045','000051','000053','000Y45') and des_detalle_lease  = 'VEICULOS PESADOS DE MERCADORIAS' then 'Heavy Vehicle'
						 ...
						 when ckprodmi in ('000045','000051','000053','000Y45') and des_detalle_lease = 'TRICICLO%' then 'Motorcycle'  
						 when ckprodmi in ('000045','000051','000053','000Y45') and des_detalle_lease like 'CICLOMOTOR%' then 'Motorcycle' 						 
						 when ckprodmi in ('000045','000051','000053','000Y45') and des_detalle_lease  = 'REBOQUE/SEMI-REBOQUE C/MATRICULA' then 'Heavy Vehicle'
...
left join (select * from bu_esg_work.avg_emis_fact_veh_dez23) avg_emiss_veh_score5
...
left join (select * from bu_esg_work.avg_km_dez23) avg_km_score5
...
-- Cruzamento para quando é sabido o tipo de edificío (apenas office à data)
        left join ( 
                    select *
                    from bu_esg_work.pilar3_avg_emission_realstate_jun23
